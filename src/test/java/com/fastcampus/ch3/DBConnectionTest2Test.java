...
public class DBConnectionTest2Test {
    ...
    public int updateUser(User user) throws Exception {
        ...
        return pstmt.executeUpdate(); // insert, delete, update 일 때 사용
    }
    ...
    private void deleteAll() throws Exception {
        ...
        PreparedStatement pstmt = conn.prepareStatement(sql); //SQL Injection공격, 성능향상
        pstmt.executeUpdate(); // insert, delete, update 일 때 사용
    }
...
//        values ('asdf', '1234', 'smith', 'aaa@aaa.com', '2022-12-03', 'facebook', now());
        ...
        int rowCnt = pstmt.executeUpdate(); // insert, delete, update 일 때 사용
